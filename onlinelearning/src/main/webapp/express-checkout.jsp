                        ...
                        <div class="container">
                            <div class="express-checkout-container">
                                ...
                                <div class="checkout-summary">
                                    ...
                                    <div class="course-info">
                                        ...
                                        <div class="course-meta">
                                            <div class="meta-item">
                                                <i class="fa fa-user"></i> ${course.instructorName}
                                            </div>
                                            <div class="meta-item">
                                                <i class="fa fa-clock"></i> ${course.duration}
                                            </div>
                                            <div class="meta-item">
                                                <i class="fa fa-users"></i> ${course.studentCount} students
                                            </div>
                                        </div>
                                        <div class="price">
                                            ${pricePackage.salePrice}đ
                                            <c:if test="${pricePackage.originalPrice > pricePackage.salePrice}">
                                                <div class="discount">
                                                    <span class="original-price">${pricePackage.originalPrice}đ</span>
                                                    <span class="discount-percentage">
                                                        ${Math.round((1 - pricePackage.salePrice / pricePackage.originalPrice) * 100)}% OFF
                                                    </span>
                                                </div>
                                            </c:if>
                                        </div>
                                ...
                                <form class="checkout-form" action="express-checkout" method="post" id="expressCheckoutForm">
                                    ...
                                    <input type="hidden" name="pricePackageId" value="${param.pricePackageId}">
                                    ...
                                    <div class="login-option">
                                        ...
                                        <a href="login?redirect=payment&courseId=${param.courseId}&pricePackageId=${param.pricePackageId}">Sign in</a>
                                    </div>
                                </form>
                            </div>
                        </div>
