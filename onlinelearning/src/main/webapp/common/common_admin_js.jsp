...
<!-- Sửa đường dẫn CSS thành link tag hoặc xóa nếu đã được thêm ở nơi khác -->
<!-- <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/vendors/scroll/scrollbar.css"> -->
