...
<header class="ttr-header">
	<div class="ttr-header-wrapper">
			...
			<ul class="ttr-header-navigation">
				...
				<li>
					...
					<div class="ttr-header-submenu">
						<ul>
							<li><a href="${pageContext.request.contextPath}/listCourse">Our Courses</a></li>
							<li><a href="${pageContext.request.contextPath}/event.jsp">Events</a></li>
							<li><a href="${pageContext.request.contextPath}/listPost">Blog</a></li>
						</ul>
					</div>
				</li>
			</ul>
			...
			<ul class="ttr-header-navigation">
				...
				<c:if test="${sessionScope.account!=null}">
					...
					<li>
						<a href="#" class="ttr-material-button ttr-submenu-toggle"><span class="ttr-user-avatar"><img
								alt="" src="${pageContext.request.contextPath}/assets/images/testimonials/pic3.jpg" width="32" height="32"></span></a>
						<div class="ttr-header-submenu">
							<ul>
								<li><a href="${pageContext.request.contextPath}/profile?id=${sessionScope.account.userId}">My profile</a></li>
				...
				<li class="ttr-hide-on-mobile">
					...
					<div class="ttr-header-submenu ttr-extra-menu">
						...
						<a href="${pageContext.request.contextPath}/listPost">
							<i class="fa fa-file-text-o"></i>
							<span>Blog</span>
						</a>
						<a href="${pageContext.request.contextPath}/profile?id=${sessionScope.account.userId}">
		...
		<div class="ttr-search-bar">
			<form class="ttr-search-form" action="${pageContext.request.contextPath}/search" method="get">
